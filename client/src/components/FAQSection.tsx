  ...
  return (
    <section id="faq" className="py-16">
      <div className="text-center mb-10">
        ...
        <p className="text-[#8E8E8E] max-w-2xl mx-auto">
      ...
      <div className="max-w-3xl mx-auto">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="border border-gray-200 bg-white rounded-lg mb-4 overflow-hidden shadow-sm">
            ...
            <AccordionContent className="px-6 pb-4 pt-2 text-[#8E8E8E]">
          ...
          <AccordionItem value="item-2" className="border border-gray-200 bg-white rounded-lg mb-4 overflow-hidden shadow-sm">
            <AccordionTrigger className="px-6 py-4 hover:bg-gray-50 [&[data-state=open]]:bg-gray-50">
          ...
          <AccordionItem value="item-3" className="border border-gray-200 bg-white rounded-lg mb-4 overflow-hidden shadow-sm">
            <AccordionTrigger className="px-6 py-4 hover:bg-gray-50 [&[data-state=open]]:bg-gray-50">
              <span className="text-left font-medium">Which files do I need to upload?</span>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-4 pt-2 text-[#8E8E8E]">
              After downloading your Instagram data, look for the file named <code className="bg-gray-100 px-1 py-0.5 rounded text-[#FD1D1D]">followers_and_following.json</code> in the downloaded package. This file contains all the information we need to analyze your followers and unfollowers. If you can't find this specific file, you can also upload both <code className="bg-gray-100 px-1 py-0.5 rounded text-[#FD1D1D]">followers.json</code> and <code className="bg-gray-100 px-1 py-0.5 rounded text-[#FD1D1D]">following.json</code> files.
            </AccordionContent>
          </AccordionItem>
          
          <AccordionItem value="item-4" className="border border-gray-200 bg-white rounded-lg mb-4 overflow-hidden shadow-sm">
            <AccordionTrigger className="px-6 py-4 hover:bg-gray-50 [&[data-state=open]]:bg-gray-50">
          ...
          <AccordionItem value="item-5" className="border border-gray-200 bg-white rounded-lg mb-4 overflow-hidden shadow-sm">
            <AccordionTrigger className="px-6 py-4 hover:bg-gray-50 [&[data-state=open]]:bg-gray-50">
          ...
          <AccordionItem value="item-6" className="border border-gray-200 bg-white rounded-lg mb-4 overflow-hidden shadow-sm">
            <AccordionTrigger className="px-6 py-4 hover:bg-gray-50 [&[data-state=open]]:bg-gray-50">
