    ...
    <div class="container navbar-container">
      <div class="navbar-logo">
        <router-link to="/" class="logo-link">
          <span class="logo-text">Unfollower<span class="text-gradient">Track</span></span>
        </router-link>
      </div>
      ...
      <div class="navbar-menu" :class="{ 'active': isMenuOpen }">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="#hero-section" class="nav-link" @click="closeMenu">Home</a>
          </li>
          <li class="nav-item">
            <a href="#upload-section" class="nav-link" @click="closeMenu">Upload Data</a>
          </li>
          <li class="nav-item">
            <a href="#faq-section" class="nav-link" @click="closeMenu">FAQ</a>
          </li>
        </ul>
      </div>
